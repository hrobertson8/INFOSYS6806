...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bookstore Address: " + bookstoreAddress.getHouseNumber() + " "
				+ bookstoreAddress.getStreetName() + ", " + bookstoreAddress.getZipcode());
		System.out.println();

		// get book and author attributes //set book attributes: has a name, ISBN, and
		// set author attributes: first, last, dob, address
		...
		System.out.println("Author Address: " + authorAddress.getHouseNumber() + " " + authorAddress.getStreetName()
				+ ", " + authorAddress.getZipcode());
